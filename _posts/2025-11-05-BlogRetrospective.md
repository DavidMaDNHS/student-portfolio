---
title: "Blog/Retrospective for Tri 1"
description: "My Reflection over Tri 1 in CompSci"
layout: post
permalink: /BlogRetrospective/
---
...
Throughout this first trimester, I think the most important thing I learned was the main concept of CompSci, as I was someone who never knew anything about the skill before. Now, I started to understand better and be more confident, positive about computer science(specially you can think of it as understanding CompSci from the basics, learning the tools like Github and VScode, then organizing and understanding how the entire web and information developemtn works). Even though I am not the best person at socializing, I kind of learned how to communicate with others, and how I can express my ideas to others through issues on Github. I did struggle a lot with setting up the tools in the beginning, but looking back, now I understand it is just to set up the digital tools so I can start designing content while helping others at the same time. The second and third sprints, even though I can say I was not confident and sometimes didnt understand how I was supposed to even write the codes to form the designs I wanted(not everything covered in the lessons from Sprint2), I understood some necessary assistance from AI and others is needed. I still have a few questions, in order to truly learn and be confident in CompSci, sometimes I dont know how to create the content I wanted and always wondered how people around me created them so easily, I know we use Ai, how are we supposed to learn and be proficient in these skills?

## 2. Key things from the 3 sprints
Sprint 1, setting up the tools, laerning how to edit(download proper files, commit(push and pull), and set up venv) and make changes on VScode and then deploying them on github, contents included game hacks(snake), designing lessons to help new students to learn how to setup the tools(LXD), ex different code types or fundamental concepts needed to understand the process of using VScode and the general process of coding.
...
Sprint 3: Me and team had created the "digital-famine" story of earth losing its technology and visiting planets(each with a skill) is ncessary to help restore earth due to alien disturbence. Skills on thse planets include "micrblogging", "cyber skills", "AI" use, "cyber", as well as numerous accidents in between that needed to be solved through testing your knowledges. I specifically focused on the Cyber concepts.


## 3. N@M Reflection and Comments

During Night at the Museum, our CSP(codemaxxer) team presented Digital Famine, showcasing what we learned about coding, problem-solving, and teamwork. Visitors interacted with the game and saw how we applied computer science concepts in a creative way. Despite the room being noisy, it was a valuable experience to share our project and learning with others.
...
Commits: 127
- Sprint 1 Links of change: 
https://github.com/DavidMaDNHS/student-portfolio/issues/3

https://github.com/DavidMaDNHS/student-portfolio/issues/4

- Sprint 2 Progress: https://github.com/DavidMaDNHS/student-portfolio/issues/5

- Sprint 3 Progress: 
https://github.com/P4CodeMaxxers/digitalFamine/issues/16

https://pages.opencodingsociety.com/digital-famine/end/submodule_4/
...
- Q4: Answer A(A simulation of flipping a fair coin)
This option is correct. There are only two possible results of a coin flip, which can be stored in a Boolean variable as true or false.
- Q5: Answer C
This option is correct. This code segment initially sets One word, ticket Price to 12, and then changes the price to 9 only for children and seniors. The code segment then increases One word, ticket Price by 5 for 3-D movies.
- Q6: Answer A
This option is correct. The IETF develops and oversees standards such as hypertext transfer protocol (HTTP), Internet protocol (IP), and simple mail transfer protocol (SMTP).
- Q9: Answer D
...
- Q16: Answer D
This option is correct. If the album was purchased and downloaded through a licensed music store, the user will not be in violation of the DMCA.
- Q19: Answer A
...
- Q45: Answer C
This option is correct. The expression P AND Q evaluates to true when both P and Q are true, and evaluates to false otherwise. Therefore, the expression NOT, open parenthesis, P AND Q, close parenthesis evaluates to false when both P and Q are true, and evaluates to true otherwise.
- Q48: Answer D
...
- Q50: Answer B
This option is correct. The procedure implements a linear search, which sequentially compares each element of the list with the target
